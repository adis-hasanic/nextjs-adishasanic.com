        ...
        <div className="row">
          <div className="about">
            ...
            <div className="about-row">
              <p>I'm Adis Hasanic, 24 years old, from Bosnia and Herzegovina. For the past 9 years, I've been designing UI and UX, websites, and all sorts of visuals. I've mostly worked for tech startups, backers of which include YCombinator, 500 Startups, TechStars, Sequoia, etc. Mostly worked remotely, while on-site 1 year at Branded.me and Kamcord in San Francisco, CA (Sep 2014 - Sep 2015), and 1 year at Teamscope in Tallinn, Estonia (Jan 2019 - Jan 2020).</p>
