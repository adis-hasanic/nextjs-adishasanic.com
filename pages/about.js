        ...
        <div className="row">
          <div className="about">
            ...
            <div className="about-row">
              <p>My name is Adis, I'm a 24-year-old product designer from Bosnia and Herzegovina. Occasionally, I have also designed websites for announcing, explaining or selling a product. As well as various visual material used in marketing, sales, advertising. And design systems recently.</p>
