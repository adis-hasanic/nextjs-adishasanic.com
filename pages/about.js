...
export default function Home() {
  ...
  `,
      ...
      <div className="text">
      <div className="text-100">
      Past 10 years designing for early-stage startups backed by YC, A16Z, Sequoia, and TechStars. From problems, goals, and ideas, through research, user flows, visual, design system, HTML and CSS, testing, feedback and discussions, to user experience and interface that is easy to use and looks great while communicating brand values.
      </div>
      </div>
      </div>
