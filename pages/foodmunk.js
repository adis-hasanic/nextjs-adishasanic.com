...
export default function Home() {
  ...
  `,
      ...
      <div className="work">
        ...
        <Link href="typen"><a href="typen"><div><img src="arrow-left-web.svg"></img></div></a></Link>
          <Link href="kamcord"><a href="kamcord"><div><img src="arrow-right-web.svg"></img></div></a></Link>
        </div>
        </div>
      </div>

      <div className="arrows-mobile">
      <Link href="typen"><a href="typen"><div><img src="arrow-left-mobile.svg"></img></div></a></Link>
          <Link href="kamcord"><a href="kamcord"><div><img src="arrow-right-mobile.svg"></img></div></a></Link>
        </div>
