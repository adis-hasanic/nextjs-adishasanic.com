                ...
                <div className="container">
                    ...
                    <div className="section intro">
                        ...
                        <div className="section text">
                            <h1>I'm Adis, a 24-year-old UI/UX designer based in Bosnia and Herzegovina, with 9 years of experience designing products, websites and visual past 9 years for startups backed by YC, Sequoia, TechStars, etc.</h1>
                            <p>Currently looking for a full-time role, preferably at a startup in Europe, as I'm also looking to relocate from Bosnia to more of a tech hub and work closely on building a great digital product.
<br></br><br></br>
Self-taught, started from practicing Photoshop and web design at age 13. Used Sketch mostly, Figma lately. Some experience lately with design systems and learned a bit about how React works. I love designing for screen, structuring information and processes, and working in an agile way — mockups, discussing, iterating, launching. User research via surveys, interviews and testing is something I’d like to start practicing.</p>
                        </div>
                    </div>
