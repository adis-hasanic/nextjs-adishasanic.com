  ...
  `,
      ...
      <div className="content index">
        ...
        <div className="row live intro">
          ...
          <h1><img src="/adis-hasanic.jpg"></img><br></br>I’m Adis, a 24-year-old digital product designer from Bosnia and Herzegovina. Past 10 years I've been designing UI/UX, websites and visual at early-stage startups building web platforms and mobile apps, backers of which include YCombinator, TechStars, Sequoia, 500 Startups, Tencent, Khosla, etc.<br></br><br></br>On a gaming forum, I stumbled upon Photoshop when I was 12, made an abstract image and thought "This is it, this is what I want to do for a living." I started posting my work of graphic design and web design on showcase websites when I was 13, which led to part-time remote work at a Chicago-based startup when I was 15, where I was hired to design UI and UX of a web app. I just kept doing it since, mostly as a freelancer remotely, on-site 1 year in San Francisco and 1 year in Tallinn. I’ve had plans to study Industrial Design when I was 19, but after taking drawing classes, I realized I don’t wish to move away from shaping interfaces, so I'm a self-taught who learned through working, reading and talking with smart people in tech.<br></br><br></br>Currently based in Bosnia and Herzegovina. Looking to join an early-stage startup in EU or UK, start remotely and relocate when possible. My process is just drafts (mockups in Figma or Sketch) and feedback (discussions and metrics/user-feedback), so I think the best way to get started is just to try working together for a week or two and see where to go from there.<br></br><br></br><a href="/Adis-resume.pdf">Resume</a> <a href="mailto:adishasanic96@gmail.com">Email</a></h1><br></br>
        </div>
