...
export default function Home() {
  ...
  `,
      ...
      <div className="description">Blake hired me to design Engine's admin panel, to make it easy for anyone to set up and manage an online store using Engine. We worked closely via Slack for several months.</div>
      </div>
      </div>
      ...
      <div className="description">Meitu was a startup at Series C providing photo-editing mobile apps. Kelsey was based in LA and hired me to design a set of infographics.</div>
      </div>
      </div>
