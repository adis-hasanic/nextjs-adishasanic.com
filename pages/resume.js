      ...
      <div className="content">
        <div className="row">
          <div className="about">
            ...
            <div className="experience">
              <div className="type">Freelance</div>
              <div className="spacetime">3 months (Jun 2017 – Aug 2017) · Remote</div>
              <div className="name"><a href="https://www.crunchbase.com/organization/meitu" target="_blank">Meitu</a></div>
              <div>Series-B startup based in China and US. Backed by Qiming Ventures, etc.<br></br> One of the leading providers of photo-editing apps on mobile.</div>
            ...
            <div className="experience">
              ...
              <div className="name"><a href="https://www.crunchbase.com/organization/engine-ecommerce" target="_blank">Engine</a></div>
            ...
            <div className="experience">
              <div className="type">Founder</div>
              <div className="spacetime">6 months (Jul 2016 – Jan 2017) · Remote</div>
              <div className="name">Typen</div>
              <div>I designed a web-based writing app, recruited developer, advertised and talked to users.<br></br> 2000 signups, positive feedback. Low retention, high cost (time and maintenance).</div>
              <div className="role">UX/UI, Web, Visual</div>
            </div>

            <div className="experience">
              <div className="type">Freelance</div>
              <div className="spacetime">6 months (Jan 2016 – Jun 2016) · Remote</div>
              <div className="name">Foodmunk by <a href="https://www.crunchbase.com/organization/fuel-5" target="_blank">Fuel</a></div>
              <div>Early-stage 3-person startup based in San Francisco. Backed by 500 Startups.<br></br> iOS-based nutrition assistant.</div>
            ...
            <div className="experience">
              ...
              <div className="name"><a href="https://multiplylabs.com/" target="_blank">MultiplyLabs</a></div>
            ...
            <div className="experience">
              ...
              <div className="name"><a href="https://medium.com/@Kamcord/were-joining-lyft-d1bb6523ac90" target="_blank">Kamcord</a></div>
            ...
            <div className="experience">
              ...
              <div className="name"><a href="https://www.crunchbase.com/organization/branded-me" target="_blank">Branded.me</a></div>
            ...
            <div className="experience">
              <div className="type">Freelance</div>
              <div className="spacetime">1 year (Aug 2013 – Aug 2014) · Remote</div>
              <div className="name"><a href="https://www.crunchbase.com/organization/mobiley" target="_blank">Mobiley</a></div>
              <div>Early-stage 2-person startup based in San Francisco. Became Branded.me.<br></br> Create a mobile version of the website from your existing website.</div>
              <div className="role">UX/UI, Web, Visual</div>
            </div>

            <div className="experience">
              <div className="type">Freelance</div>
              <div className="spacetime">1 year (Jul 2012 – Jul 2013) · Remote</div>
              <div className="name"><a href="http://weebly.com/" target="_blank">Weebly</a></div>
              <div>Series-A startup based in San Francisco. Backed by YC, Sequoia, etc.<br></br> Create a website without coding.</div>
              <div className="role">Website templates</div>
            </div>

            <div className="experience">
              <div className="type">Freelance</div>
              <div className="spacetime">1 year (Jul 2012 – Jul 2013) · Remote</div>
              <div className="name"><a href="http://helpjuice.com/" target="_blank">Helpjuice</a></div>
              <div>Early-stage startup based in Austin. Backed by TechStars.<br></br> Create a knowledge-base for external (help center) and internal use.</div>
              <div className="role">UX/UI, Web, Visual</div>
            </div>
            ...
            <div className="experience">
              ...
              <div className="name"><a href="https://www.crunchbase.com/organization/turbobotz" target="_blank">Playmonks</a></div>
            ...
            <div className="experience text last">I started when I was 13 by posting my work of web design, graphic design and visual art on DeviantART and Dribbble, which led to freelance work, one of which was an early-stage startup, and I mostly continued working at startups, mostly on UX/UI of digital products (web and mobile platforms/apps).<br></br><br></br>Raised in an urban area of a small town called Zavidovici in Bosnia and Herzegovina. Born a few months after the <a href="https://en.wikipedia.org/wiki/Bosnian_War" target="_blank">Bosnian War</a> ended.</div>
